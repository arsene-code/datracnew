...
class CreateFeuilleHospitalisationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('feuille_hospitalisations', function (Blueprint $table) {
            ...
            $table->foreign('ticket_moderateur_id')
                ...
                ->onDelete('restrict')
                ->onUpdate('restrict');
            $table->unsignedBigInteger('prestation_etablissement_id')->unsigned();
                $table->foreign('prestation_etablissement_id')
                    ->references('id')
                    ->on('prestation_etablissements')
                    ->onDelete('restrict')
                    ->onUpdate('restrict');
            ...
            $table->string('nature_prestation')->nullable();
    ...
    {
        Schema::dropIfExists('feuille_hospitalisations');
    }
}
