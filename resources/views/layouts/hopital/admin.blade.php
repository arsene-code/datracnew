                ...
                <div class="tab-pane active" id="menu">
                    <nav class="sidebar-nav">
                        <ul class="main-menu metismenu">
                            ...
                            <li class="active"><a href="javascript:void(0);" class="has-arrow"><i class="icon-user-follow"></i><span>Doctors</span> </a>
                                <ul>
                                    <li><a href="doctors-all.html">All Doctors</a></li>
                                    <li><a href="doctor-add.html">Add Doctor</a></li>                       
                                    <li><a href="doctor-profile.html">Doctor Profile</a></li>
                                    <li class="active"><a href="doctor-events.html">Doctor Schedule</a></li>
                                </ul>
                            </li>
